...
enum WorldIntConfigs
{
	...
	CONFIG_SKILL_PREMIUM_GAIN_CRAFTING,
    CONFIG_SKILL_PREMIUM_GAIN_DEFENSE,
    CONFIG_SKILL_PREMIUM_GAIN_GATHERING,
    CONFIG_SKILL_PREMIUM_GAIN_WEAPON,
